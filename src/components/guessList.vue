...
export default {
  ...
  mounted() {
    this.axios
      .get(
        "https://www.lfeng.site/taskgo/app/tag?type=guess&curPage=1&pageSize=5"
      )
      .then(res => {
  ...
  methods: {
    handleSizeChange(size) {
      ...
      this.axios
        .get(
          "https://www.lfeng.site/taskgo/app/tag?type=guess&curPage=1&pageSize=" +
            size
        )
        .then(res => {
          this.tableData = res.data.result.data;
    ...
    handleCurrentChange(currentPage) {
      ...
      this.axios
        .get(
          "https://www.lfeng.site/taskgo/app/tag?type=guess&curPage=" +
            currentPage +
            "&pageSize=" +
            that.pagesize
        )
